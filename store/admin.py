...
class ForgotPasswwordAdmin(admin.ModelAdmin):
    list_display = ('phone_number', 'posted_date')

class TurkmenTelekechiAdmin(admin.ModelAdmin):
    list_display = ('addresses', 'emails', 'telekechi_phone_numbers', 'logos',)
...
admin.site.register(ForgotPassword, ForgotPasswwordAdmin)
