...
class ProductSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        model = Product
        fields = ('id', 'product_adder', 'product_name','product_price', 'product_image', 'product_image2', 'product_image3', 'product_image4', 'product_image5', 'phone_number', 'product_address', 'product_quantity', 'about_product', 'english_product_name', 'russian_product_name', 'delivery', 'credit', 'is_vip', 'liked', 'is_active', 'joined_date', 'product_category')
